...
public class Numbers {
    ...
    public void getNumbers() {
        ...
        //Fill the array list with 20 random numbers up to 50 and print them out
    ...
    public void compareNum() {
        ...
        while(index < numbers.size()){
            if(numbers.get(index).equals(userNum)){
                System.out.println("The number " + userNum + " is in the array list at slot " + index);
                pass = 'Y';
                count++;
                index++;
            }
        ...
        if (!(pass == 'Y')){
            System.out.println("Sorry. Your number was not in the array list");
        }
